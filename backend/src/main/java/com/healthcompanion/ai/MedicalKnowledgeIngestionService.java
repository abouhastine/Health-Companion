...
@Service
public class MedicalKnowledgeIngestionService {
  private final KnowledgeChunkRepository chunks;
  private final EmbeddingGateway embeddings;
  private final PgVectorStore vectors;

  public MedicalKnowledgeIngestionService(
      KnowledgeChunkRepository c, EmbeddingGateway e, PgVectorStore v) {
    chunks = c;
    embeddings = e;
    vectors = v;
  }
  ...
  @Transactional
  public int ingest(String source, String topic, String language, String version, String content) {
    int n = 0;
    for (int from = 0; from < content.length(); from += 2400) {
