...
public class AiSafetyService {
  ...
  public String safeQuestion(String question) {
    ...
    if (BLOCKED.stream().anyMatch(q::contains))
      return "The assistant cannot diagnose, prescribe, recommend treatment, or change medication. It can explain factual values and suggest discussing them with a healthcare professional.";
    return null;
  }
}
