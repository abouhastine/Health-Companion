...
public class AdminKnowledgeController {
  private final MedicalKnowledgeIngestionService ingestion;

  public AdminKnowledgeController(MedicalKnowledgeIngestionService i) {
    ingestion = i;
  }
  ...
  public record Result(int chunksCreated) {}
}
